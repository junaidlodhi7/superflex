...
@Component({
  selector: 'app-softgoods-models',
  templateUrl: './softgoods-models.component.html',
  styleUrls: ['./softgoods-models.component.scss']
})
export class SoftgoodsModelsComponent implements OnInit {
    ...
    getSoftgoodsModels(page){
        this.softgoodsModelsService.list(page).subscribe(res => {
            let response = res.json();
            if(response.success)
            {
                this.softgoodsModels = response.data;
    ...
    public onChangeTable(page:any = {page: this.page, itemsPerPage: this.itemsPerPage}):any {
        this.getSoftgoodsModels(page.page);
    }
    ...
    onSubmit(){
        ...
        this.softgoodsModelsService.createSoftgoodsModel(HV).subscribe( result => {
